...
public class CreateProject extends javax.swing.JFrame {
    ...
    private void btn_createActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_createActionPerformed
        ...
        // Oluşturulan projeye özel unique key oluştur
        String uniqueKey = UniqueKeyGenerator.generateUniqueKey();

        // Projeyi veritabanına kaydet
        DatabaseManager.createProject(projectName, projectDescription, uniqueKey, userId);
        
        // Option pane'de unique key'i göster
        JOptionPane.showMessageDialog(this, "Project created successfully.\nUnique Key: " + uniqueKey, "Success", JOptionPane.INFORMATION_MESSAGE);
